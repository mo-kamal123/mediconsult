...
const NewApprovalForm = () => {
    const [diagnosis, setDiagnosis] = useState(['Flatulence', 'Paratyphoid fever A | A01.1']);

  return (
    <Form>
      {/* Approval Information */}
      <div className="">
        <h2 className="font-semibold text-[#1F4ED6] text-lg mb-6">Approval Information</h2>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Input label="Member Card No/National Id" name="memberId" />
          <DropDown label="Provider Name" name="providerName" data={[]}              className="p-6 mt-1 min-w-[200px]"/>
          <DropDown label="Provider Branch" name="providerBranch" data={[]}              className=" p-6 mt-1 min-w-[200px]"/>
          ...
          <DropDown label="Diagnosis" name="diagnosis" data={[]} multiple selected={diagnosis}              className=" p-6 mt-1 min-w-[200px]"/>

          <Input label="Email / Phone Number" name="contact" />
          <Input label="Comment" name="comment" placeholder="Without a prescription" />
